...
export const CHECK_OR_UNCHECK = "CHECK_OR_UNCHECK";
export const CHECK_OR_UNCHECK_SUCCESS = "CHECK_OR_UNCHECK_SUCCESS";
export const CHECK_OR_UNCHECK_FAILURE = "CHECK_OR_UNCHECK_FAILURE";

export const COPY_CARD = "COPY_CARD";
export const COPY_CARD_SUCCESS = "COPY_CARD_SUCCESS";
export const COPY_CARD_FAILURE = "COPY_CARD_FAILURE";
